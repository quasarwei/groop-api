...
VALUES
  ...
  -- password = 'pass' 
    '$2a$12$bbV7LrRWFzM27uJgcbxTpe9syDnuIGhaiNMDY/ty4m31r8GSSQzUC', 'user1@email.com', true),
  ('username2', 'first2 last2', '$2a$12$bbV7LrRWFzM27uJgcbxTpe9syDnuIGhaiNMDY/ty4m31r8GSSQzUC', 'user2@email.com', false),
  ('username3', 'first3 last3', '$2a$12$bbV7LrRWFzM27uJgcbxTpe9syDnuIGhaiNMDY/ty4m31r8GSSQzUC', 'user3@email.com', true),
  ('username4', 'first4 last4', '$2a$12$bbV7LrRWFzM27uJgcbxTpe9syDnuIGhaiNMDY/ty4m31r8GSSQzUC', 'user4@email.com', false),
  ('username5', 'first5 last5', '$2a$12$bbV7LrRWFzM27uJgcbxTpe9syDnuIGhaiNMDY/ty4m31r8GSSQzUC', 'user5@email.com', true),
  ('username6', 'first6 last6', '$2a$12$bbV7LrRWFzM27uJgcbxTpe9syDnuIGhaiNMDY/ty4m31r8GSSQzUC','user6@email.com', true);
